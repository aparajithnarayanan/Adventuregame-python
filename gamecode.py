...
required = ("\nUse only A, B, or C\n")
def intro():
    print("After six tiring days wandering in the forest wih your friends, you finally reach your destination the temple of Alacee."
    "It's three in the morning and you realize that all your friends are not there with you."
    "You are shocked and scared to be alone,suddenly...a monster coming towards you!.You will:")
    time.sleep(1)
...
def option_run():
  print ("\nYou run as quickly as possible, but the monster "
